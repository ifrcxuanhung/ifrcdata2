...
<section class="grid_12">
    <div class="block-border">
        <form class="block-content form-table-ajax" id="" method="post" action="">
            <h1><?php trans('mn_view_events'); ?></h1>

            <table id="vndb_ca_daily" class="table table-events-list table-ajax" table="vndb_ca_daily" cellspacing="0" width="100%" style="display: table">
                <thead>
                    <tr width="1%">
